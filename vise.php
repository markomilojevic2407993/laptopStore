...
<div class="container text-center bg-primary navigacija">
        <div class="row">
            ...
            <div class="col">
                ...
                <a class="text-white text-decoration-none fs-4 m-4" href="<?= $link?>" class="m-3 myNav"><?= $title ?></a>
                <?php endforeach; ?>
            </div>
            
            <div class="col ">
            <?php foreach($navSocial as $titleSocial => $icon): ?>
                <a class="text-white text-decoration-none fs-4 m-4" href="<?= $titleSocial?>"><img src="<?= $icon ?>" class="m-2"></a>
                <?php endforeach; ?>
            </div>
